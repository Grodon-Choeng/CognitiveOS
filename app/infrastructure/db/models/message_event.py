...
class MessageEventLogModel(Base):
    ...
    __table_args__ = (
        Index("ix_message_event_logs_recorded_at", "recorded_at"),
        Index("ix_message_event_logs_conversation_id", "conversation_id"),
        Index("ix_message_event_logs_session_id", "session_id"),
        Index("ix_message_event_logs_channel", "channel"),
    )
